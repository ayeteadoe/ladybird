...
Utf8View Utf8GenericLexer::consume_quoted_string(u32 escape_char)
{
    ...
    if (is_eof() || peek() != quote_char) {
        ...
        m_iterator = m_input.iterator_at_byte_offset_without_validation(start_offset -
            m_input.byte_offset_of(m_input.iterator_at_byte_offset_without_validation(start_offset)));
        return {};
    }
