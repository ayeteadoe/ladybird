...
WEB_API BlobURLStore& blob_url_store();
WEB_API ErrorOr<String> generate_new_blob_url();
WEB_API ErrorOr<String> add_entry_to_blob_url_store(GC::Ref<Blob> object);
WEB_API bool check_for_same_partition_blob_url_usage(URL::BlobURLEntry const&, GC::Ref<HTML::Environment>);
...
WEB_API Optional<BlobURLEntry const&> resolve_a_blob_url(URL::URL const&);
