...
WEB_API GC::Ptr<Web::DOM::Node> get_node(HTML::BrowsingContext const&, StringView reference);
WEB_API String get_or_create_a_node_reference(HTML::BrowsingContext const&, Web::DOM::Node const&);
WEB_API bool node_reference_is_known(HTML::BrowsingContext const&, StringView reference);
...
WEB_API ErrorOr<GC::Ref<Web::DOM::Element>, WebDriver::Error> deserialize_web_element(Web::HTML::BrowsingContext const&, JsonObject const&);
WEB_API ErrorOr<GC::Ref<Web::DOM::Element>, WebDriver::Error> deserialize_web_element(Web::HTML::BrowsingContext const&, JS::Object const&);
...
WEB_API bool is_element_stale(Web::DOM::Node const& element);
WEB_API bool is_element_interactable(Web::HTML::BrowsingContext const&, Web::DOM::Element const&);
WEB_API bool is_element_pointer_interactable(Web::HTML::BrowsingContext const&, Web::DOM::Element const&);
...
WEB_API String get_or_create_a_shadow_root_reference(HTML::BrowsingContext const&, Web::DOM::ShadowRoot const&);
WEB_API JsonObject shadow_root_reference_object(HTML::BrowsingContext const&, Web::DOM::ShadowRoot const&);
WEB_API bool represents_a_shadow_root(JsonValue const&);
WEB_API bool represents_a_shadow_root(JS::Value);
WEB_API ErrorOr<GC::Ref<Web::DOM::ShadowRoot>, WebDriver::Error> deserialize_shadow_root(Web::HTML::BrowsingContext const&, JsonObject const&);
WEB_API ErrorOr<GC::Ref<Web::DOM::ShadowRoot>, WebDriver::Error> deserialize_shadow_root(Web::HTML::BrowsingContext const&, JS::Object const&);
...
WEB_API bool is_shadow_root_detached(Web::DOM::ShadowRoot const&);

WEB_API String element_rendered_text(DOM::Node&);

WEB_API CSSPixelPoint in_view_center_point(DOM::Element const& element, CSSPixelRect viewport);
