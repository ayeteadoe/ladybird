...
WEB_API void cross_realm_transform_send_error(JS::Realm&, HTML::MessagePort&, JS::Value error);
WEB_API WebIDL::ExceptionOr<void> pack_and_post_message(JS::Realm&, HTML::MessagePort&, StringView type, JS::Value value);
WEB_API WebIDL::ExceptionOr<void> pack_and_post_message_handling_error(JS::Realm&, HTML::MessagePort&, StringView type, JS::Value value);
