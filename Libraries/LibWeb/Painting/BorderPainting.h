...
WEB_API void paint_border(DisplayListRecorder& painter, BorderEdge edge, DevicePixelRect const& rect, CornerRadius const& radius, CornerRadius const& opposite_radius, BordersDataDevicePixels const& borders_data, Gfx::Path&, bool last);
...
WEB_API Gfx::Color border_color(BorderEdge edge, BordersDataDevicePixels const& borders_data);
