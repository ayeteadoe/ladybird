...
// FIXME: Include the Vulkan utility headers in our Vulkan dependency.
// https://github.com/KhronosGroup/Vulkan-Headers/issues/414
// https://github.com/KhronosGroup/Vulkan-Utility-Libraries/blob/main/include/vulkan/vk_enum_string_helper.h
inline char const* string_VkResult(VkResult const input_value)
{
    switch (input_value) {
    case VK_SUCCESS:
        return "VK_SUCCESS";
